...
export_mattermost_env() {
    ...
    for i in $(seq 0 $((env_count - 1))); do
        ...
        case "$var_name" in
            MM_CONFIG|MM_SQLSETTINGS_DRIVERNAME|MM_SQLSETTINGS_DATASOURCE|MM_SERVICESETTINGS_LISTENADDRESS|MM_SERVICESETTINGS_SITEURL|MM_FILESETTINGS_DIRECTORY|MM_PLUGINSETTINGS_DIRECTORY|MM_PLUGINSETTINGS_CLIENTDIRECTORY)
